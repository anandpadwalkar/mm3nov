...
public interface RoleCreationService {
    ...
    public PaginationResponse getPaginationResponse(int sEcho,int pageStart, int pageLength, int sortCulumn,String sortDirection,
       String search,int roleTypeId);
