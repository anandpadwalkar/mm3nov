...
<jsp:include page="script.jsp" />
	...
	<script type="text/javascript">
		function setUniversity(uid, code, name)
		{
			$("#code").val(code);
			$("#uname").val(name);
		}
        ...
        <div class="second-column one-child-container relative padding-top-75px"> 
          ...
          <div id="my_documents_container" class="column-one clearfix">
            <div class="grid box-filters">
                ...
                <form class="form-inline ng-pristine ng-valid" method="post" action="./university/add" >
                      <div class="row-fluid">
                  ...
                  <thead>
                    ...
                    <c:forEach items="${universityList}" var="university">  
                        <tr class="odd">
                          ...
                          <td class=" ">
                          	<a href="#assigntoProject" data-toggle="modal" data-original-title="Add to Project" data-placement="top" style="border-radius:40px; padding:4px 6px 2px;" class="btn btn-xl btn-success button-submit font13 bs-tooltip" onclick="setUniversity(${university.id}, '${university.universityCode}', '${university.universityName}')">
